...
During this journey, I also managed significant personal responsibilities and challenges, which strengthened my resilience and adaptability. Today, I focus on architecting modular agentic systems, repo hygiene, and recruiter‑facing portfolios that demonstrate growth and transparency.
...
- Node/Express demos  
- Python data science notebooks (NumPy, Pandas)  
...
- Cloud & DevOps practices (Docker, Kubernetes, serverless models)  
- AI/LLM engineering (LangChain, LangGraph, DeepLearning.AI courses)  
- Linux troubleshooting and system recovery  
...
- **2025**: IBM Full Stack Web Development certificate completed  
- **2025–2026**: Advanced modular systems, AI/LLM engineering, recruiter‑facing portfolio  
...
- Build toward architect‑level roles via modular agentic systems  
